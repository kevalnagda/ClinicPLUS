...
def api():
	...
	database = 'clinicplus'
	query = """SELECT *
	        FROM clinicplus.diagnostic_breast_cancer
	        -- In this step, just grab rows that have a target
	        WHERE Prediction is not null ORDER BY ID DESC LIMIT 1"""
	...
	trained_model = healthcareai.load_saved_model('2019-02-02T15-59-46_classification_RandomForestClassifier.pkl')
	...
	userid = 'root'
	password = ''
	table = 'diagnostic_breast_cancer'

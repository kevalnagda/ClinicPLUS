...
def api():
	...
	database = 'clinicplus'
	query = """SELECT *
	        FROM clinicplus.cervical
	        -- In this step, just grab rows that have a target
	        WHERE Biopsy is not null ORDER BY PatientID DESC LIMIT 1"""
	...
	trained_model = healthcareai.load_saved_model('2019-02-02T12-27-11_regression_LinearRegression.pkl')

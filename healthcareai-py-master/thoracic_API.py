...
def api():
	...
	database = 'clinicplus'
	query = """SELECT *
	        FROM clinicplus.thoracic
	        -- In this step, just grab rows that have a target
	        WHERE Risk1Yr is not null ORDER BY PatientID DESC LIMIT 1"""
	...
	trained_model = healthcareai.load_saved_model('2019-02-02T12-59-54_classification_RandomForestClassifier.pkl')

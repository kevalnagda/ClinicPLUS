                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="pricing-info.html">Dashboard Pricing</a></li>
                      <li><a href="diabetes-info.html">Dashboard Diabetes</a></li>
                      <li><a href="custom-info.html">Custom Dashboard</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
